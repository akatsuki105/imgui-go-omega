...
void IggMemoryEditorDrawContents(IggMemoryEditor handle, void *mem_data, size_t mem_size, size_t base_display_addr)
{
  MemoryEditor *mem_editor = reinterpret_cast<MemoryEditor *>(handle);
  mem_editor->DrawContents(mem_data, mem_size, base_display_addr);
}
